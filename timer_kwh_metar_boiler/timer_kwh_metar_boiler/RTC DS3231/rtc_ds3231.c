...
void DS3231_init()
{
	...
	DS3231_Write(ageoffsetREG, 138);	//izmerio sam da kasni 0.98ppm (-1s na 12 dana). Svaki bit utice +/- 0.1ppm, a negativne vrednosti ubrzavaju vreme. Idealno bi sada trebao da brza 0.02ppm
												//posto je prvi broj SIGN, siftujem 1 na MSB sto predstavlja -10, sto je u unsigned = 138
} 
